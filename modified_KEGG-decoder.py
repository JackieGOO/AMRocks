...
V.0.4 Adds sections that more accurately represents anoxygenic photosynthesisscreen 
...
function_order = ['glycolysis', 'TCA Cycle', 
 'Cytochrome c oxidase', 'Cytochrome c oxidase, cbb3-type', 'Cytochrome bd complex', 'RuBisCo', 
'CBB Cycle', 'rTCA Cycle', 'Wood-Ljungdahl', 
'3-Hydroxypropionate Bicycle', '4-Hydroxybutyrate/3-hydroxypropionate', 
'ammonia oxidation (amo/pmmo)',  'nitrite oxidation', 
'dissim nitrate reduction', 'nitrite reduction', 
...
'thiosulfate oxidation', 'sulfur reductase sreABC', 
'thiosulfate/polysulfide reductase', 'sulfur disproportionation', 'sulfur dioxygenase', 
'sulfite dehydrogenase', 'sulfide oxidation', 'sulfur assimilation',
'NiFe hydrogenase', 'ferredoxin hydrogenase', 
'membrane-bound hydrogenase', 'NAD-reducing hydrogenase', 
